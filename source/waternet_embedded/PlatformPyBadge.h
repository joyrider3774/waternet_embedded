...
//Only one skin fits in the flash next to the game, the tile sheets of all four take more than the
//512 KB there is: -1 = every skin, n = only skin n, see FORCESKIN in defines.h. A 1 bpp buffer
//picks the black & white skin itself. A build can still set it itself
