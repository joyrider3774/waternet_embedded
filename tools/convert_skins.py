...
"""Convert the skin images in assets to the flash data headers the game includes.
  ...
  assets/skins  -> source/waternet_embedded/images

The title and congratulations screens become run length encoded headers (<name>_RLE565.h,
see png2rle565.py), the other images raw RGB565 little endian headers (<name>_RGB565_LE.h,
see png2rgb565.py).
...
SOURCE_DIR = os.path.join(ROOT, "source", "waternet_embedded")
